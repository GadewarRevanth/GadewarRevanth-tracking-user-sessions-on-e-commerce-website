	...
	<!-- <div id="sidebar"> -->
		...
		<!-- <ul style="margin-top:77px">
			<li class="electronic-menu"><a class='electronics'> ELECTRONICS</a>
				...
				<li><a href="search.php?catag=Books"><i class=""></i>Books</a></li>
				<li><a href="search.php?catag=Laboratory"><i class=""></i>Laboratory</a></li>
				<li><a href="search.php?catag=Sports"><i Sports=""></i>Mouse</a></li>
				<li><a href="search.php?catag=foods"><i class=""></i>foods</a></li>
				</ul>
			</li>
		</ul>
	</div> -->
