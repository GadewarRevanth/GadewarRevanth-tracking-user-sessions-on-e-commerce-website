...
<h4 style="color:black; text-align:center; font-family:bold">Manage My Account</h4>
...
<div>
   <hr>
   <h4 style="color:black;">Purchased History</h4>

<span style="color:black;"><b>Delete All History</b> </span>
...
<?php }}else { echo "<span style=color:black;><b>No Results Found</b> </span>"; 
